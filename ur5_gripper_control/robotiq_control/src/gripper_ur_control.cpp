...
GripperUR::GripperUR(){
	pub=n.advertise<std_msgs::String>("/icl_phri_ur5/ur_driver/URScript",5);
	sub=n.subscribe("/icl_phri_ur5/ur_driver/io_states",10, &GripperUR::gripper85_statusCallback,this);
	client=n.serviceClient<ur_msgs::SetIO>("/icl_phri_ur5/ur_driver/set_io");
